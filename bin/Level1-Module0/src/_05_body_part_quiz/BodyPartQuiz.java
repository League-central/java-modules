...
public class BodyPartQuiz {
	...
	String secondImage = "jack.jpeg";
	String thirdImage = "leonardo.jpeg";
	String fourthImage = "morgan.jpeg";
	String[] answers = {"Arnold Schwarzenegger", "Jack Black", "Leonardo Dicaprio", "Morgan Freeman"};
	...
	private void startQuiz() {
		...
		for (int i = 0; i < 4; i++) {
			...
			String guess = JOptionPane.showInputDialog("Who is this being?\n (first and last name)");
			...
			// -- Tell them they are wrong and who the person is
				JOptionPane.showMessageDialog(null, "Wrong!, The answer is " + answers[i] + ".");
